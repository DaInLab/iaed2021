...
prop_in_age %>%
  ggplot(aes(x=age_grp, y=heart_disease_proportion)) +
    geom_bar(stat="identity", fill="#f68060", alpha=.6, width=.4) +
    xlab("") + ylab("Proporção de Pessoas com Doença Cardíaca") + ggtitle("Proporção de Doença Cardíaca por Faixa Etária") + 
    theme_bw()
```
...
O próximo gráfico é um gráfico de dispersão de idade versus pressão arterial em repouso, que inclui **cores diferentes para o estado de doença cardíaca e o tamanho do ponto depende da depressão St**. 
