...
knitr::include_graphics("D:/GitHub/iaed2021/primeiro-projeto-modelo/imagem/unnamed-chunk-29-1.png")
```
```{r echo=FALSE, fig.width = 3, out.width = "40%", fig.align = "default", purl = FALSE}
knitr::include_graphics("D:/GitHub/iaed2021/primeiro-projeto-modelo/imagem/unnamed-chunk-29-2.png")
```
```{r echo=FALSE, fig.width = 3, out.width = "40%", fig.align = "default", purl = FALSE}
knitr::include_graphics("D:/GitHub/iaed2021/primeiro-projeto-modelo/imagem/unnamed-chunk-29-3.png")
```
```{r echo=FALSE, fig.width = 3, out.width = "40%", fig.align = "default", purl = FALSE}
knitr::include_graphics("D:/GitHub/iaed2021/primeiro-projeto-modelo/imagem/unnamed-chunk-29-4.png")
```
```{r echo=FALSE, fig.width = 3, out.width = "40%", fig.align = "default", purl = FALSE}
knitr::include_graphics("D:/GitHub/iaed2021/primeiro-projeto-modelo/imagem/unnamed-chunk-29-5.png")
```
```{r echo=FALSE, fig.width = 3, out.width = "40%", fig.align = "default", purl = FALSE}
knitr::include_graphics("D:/GitHub/iaed2021/primeiro-projeto-modelo/imagem/unnamed-chunk-29-6.png")
```
